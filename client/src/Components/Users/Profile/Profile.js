    ...
    <div>
      <main class="bg-gray-100 bg-opacity-25">
        ...
        <div class="lg:w-8/12 lg:mx-auto mb-8">
          ...
          <header class="flex flex-wrap items-center p-4 md:pt-20 sm:pt-16">
                    ...
                    <a href="#">
                      <article class="post bg-gray-100 text-white relative pb-full md:mb-6">
                        {obj.img ?
                          ...
                          // <img class="w-full h-full absolute left-0 top-0 object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRT8-e9Jpr1AyNwkdf_iE_zQjknFwrn3kBbQQ&usqp=CAU" alt="images"/>:
                          // <img class="w-full h-full absolute left-0 top-0 object-cover" src={PF+obj.img} alt="image"/>
                          <img class="w-full h-full absolute left-0 top-0 object-cover" src={PF + obj.img} alt="image" /> :
                          <img class="w-full h-full absolute left-0 top-0 object-cover" src="https://fiverr-res.cloudinary.com/images/q_auto,f_auto/gigs/167121800/original/91edbdbc9875196cc50f56337f4e1aea00534b12/your-awesome-mern-stack-developer.jpg" alt="images" />
                        }
